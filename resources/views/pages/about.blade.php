...
@section('content')
    ...
    <div class="container pt-1 pb-1 about-main-div rounded">
        ...
        <div class="container mt-3">
          <div class="row">
            <div class="col-md-6"><img class="img-fluid text-center rounded" src="{{asset('build/assets/images/about1.svg')}}" style="height: 60vh; width: 100%;" alt=""></div>
    ...
    <div class="container rounded mt-3">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <img class="img-fluid pt-4 mx-auto rounded" style="width: 100%; height: 65vh;" src="{{asset('build/assets/images/about-img.svg')}}" alt="">
          </div>
        </div>
    </div>
  ...
  <div style="padding: 20px; border-radius: 20px;" class="container">
    ...
    <div style="display: flex;">
        ...
        <div class="col-md-4">
          <img class="img-fluid mb-3" style="width: 15vw; height: auto; border-radius: 160px" src="{{asset('build/assets/images/Melvin.jpg')}}" alt="">
        ...
        <div class="col-md-4">
          <img class="img-fluid mb-3" style="width: 15vw; height: auto; border-radius: 160px" src="{{asset('build/assets/images/Ben.jpg')}}" alt="">
        ...
        <div class="col-md-4">
          <img class="img-fluid mb-3" style="width: 15vw; height: auto; border-radius: 160px" src="{{asset('build/assets/images/kerwin-profile.jpg')}}" alt="">
